...
compat = Blueprint('project', __name__)

@compat.route('/<int:id_model>', methods=['DELETE'])
@inject
...
@compat.route('/select-model/<int:id_brand>/<int:id_car>/<string:year>', methods=['GET'])
@inject
...
@compat.route('/year-models/<int:id_car>', methods=['GET'])
@inject
...
@compat.route('/car-by-brand/<int:id_brand>', methods=['GET'])
@inject
...
@compat.route('/models-id/<int:id_model>', methods=['GET'])
@inject
...
@compat.route('/model-by-id/<int:id_car>', methods=['GET'])
@inject
...
@compat.route('/all-brands', methods=['GET'])
@inject
